...
<html>
	<head>
		...
		<script type="text/javascript">
				...
				$("#mytable").DataTable({
					...
					columnDefs: [{
						...
						data: function (row, type, val, meta) {
							...
							var purchaseBtn = "<a href='javascript:storePurchase(" + row.purchaseId + ");' class='btn btn-success btn-xs'><i class=''></i>进行入库</a>&nbsp;";	
			...
			function storePurchase(purchaseId) {
				var url = "purchase/store_review/" + purchaseId;
				var width = "800px";
				var height = "600px";
				var titleHTML = "<i class='fa fa-cart-plus'></i>&nbsp;申请物资入库";

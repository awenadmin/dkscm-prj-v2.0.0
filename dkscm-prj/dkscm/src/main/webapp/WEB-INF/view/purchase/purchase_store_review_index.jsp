...
<html>
	<head>
		...
		<script type="text/javascript">
				...
				$("#mytable").DataTable({
					...
					columnDefs: [{
						...
						data: function (row, type, val, meta) {
							...
							var purchaseBtn = "<a href='javascript:store(" + row.purchaseId + ");' class='btn btn-success btn-xs'><i class=''></i>物资入库</a>&nbsp;";
			...
			// 审批窗口			
			function store(purchaseId) {
				var url = "purchase/store/" + purchaseId;
				var width = "600px";
				var height = "300px";
